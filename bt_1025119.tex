...
In the following chapter, I will provide all the necessary definitions to achieve this goal.
...
All those types of extensions can be originally found in \cite{Dung}, the more intuitive version of the grounded extension was found in \cite{Egly}.
...
\begin{itemize}
	...
	\item{preferred extension $\bm{E_{p}=\{b,c\}}$}
	\item{complete extension $\bm{E_{c}=\{j\}}$}
...
To anyone who made it this far into the paper, congratulations.\\
...
A question that I have been asked several times from parents, friends and anyone else kind enough to listen to my rambling about argumentation frameworks, is\\
\medskip
\textit{"What's the point of all this? How can you use that in real life?"}.\\
\medskip
I usually just quoted a professor from my university to get them off my back 
(\textit{"As a university that is oriented towards fundamental research, that question should not even come up."}), but since this thesis is written to benefit software engineers too,
this is a valid question and deserves some attention.\\
...
\bigskip
\begin{figure}[h!]
	\begin{center}\includegraphics[scale=0.4]{Images/Screenshot_KAFFEE_Tab1.png}
	\end{center}
\caption{Tab "Argumentation Framework"}
\end{figure}
\bigskip
\begin{figure}[h!]
	\begin{center}\includegraphics[scale=0.4]{Images/Screenshot_KAFFEE_Tab2.png}
	\end{center}
\caption{Tab "Extensions"}
\end{figure}
\bigskip
\begin{figure}[h!]
	\begin{center}\includegraphics[scale=0.4]{Images/Screenshot_KAFFEE_Tab3.png}
	\end{center}
...
\begin{thebibliography}{1}
	...
	\bibitem[\textbf{Pollock}]{Pollock} "Defeasible Reasoning"\\John Pollock; 1987
	...
	\bibitem[\textbf{BeHu}]{HunterBesnard} "Elements of Argumentation"\\Philippe Besnard, Anthony Hunter; 2008
	...
	\bibitem[\textbf{Prakken}]{Prakken} "Some reflections on two current trends in formal argumentation"\\Henry Prakken; 2012
\end{thebibliography}
