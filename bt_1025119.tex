...
For any n-ary predicate $\bm{\Phi}$, its extension can be written as $\bm{\{(x_{1},...,x_{n}) \vert \Phi(x_{1},...,x_{n})\}}$.\\
...
Next, I want to clarify a few relations between those aforementioned extensions, since they can be reused in later proofs.
